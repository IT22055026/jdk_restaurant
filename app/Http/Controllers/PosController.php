...
class PosController extends Controller
{
    ...
    public function payOrder(Request $request, Order $order)
    {
        $validated = $request->validate([
            ...
            'discount_value' => 'nullable|numeric|min:0',
            'order_type' => 'nullable|in:dine_in,takeaway',
            'split_method1' => 'nullable|string|max:30',
            'split_amount1' => 'nullable|numeric|min:0',
            'split_method2' => 'nullable|string|max:30',
        ...
        $order->update([
            ...
            'split_method1' => $validated['payment_method'] === 'mixed' ? ($validated['split_method1'] ?? null) : null,
            'split_amount1' => $validated['payment_method'] === 'mixed' ? ($validated['split_amount1'] ?? null) : null,
            'split_method2' => $validated['payment_method'] === 'mixed' ? ($validated['split_method2'] ?? null) : null,
            'split_amount2' => $validated['payment_method'] === 'mixed' ? ($validated['split_amount2'] ?? null) : null,
        ...
        return response()->json([
            ...
            'total' => (float) $total,
            'payment_method' => $validated['payment_method'],
            'split_method1' => $order->split_method1,
            'split_amount1' => $order->split_amount1 !== null ? (float) $order->split_amount1 : null,
            'split_method2' => $order->split_method2,
            'split_amount2' => $order->split_amount2 !== null ? (float) $order->split_amount2 : null,
