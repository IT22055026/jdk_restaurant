            ...
            <form action="{{ route('ingredients.update', $ingredient) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="selling_price" id="selling_price" value="{{ old('selling_price', $ingredient->selling_price) }}" step="0.01" min="0" required
                ...
                <div>
                    ...
                    @if($ingredient->image)
                        ...
                        <img id="image-preview"
                            src="{{ Str::startsWith($ingredient->image, ['http://', 'https://']) ? $ingredient->image : asset("storage/{$ingredient->image}") }}"
                            alt="{{ $ingredient->name }}"
                            class="mt-2 w-28 h-28 object-cover rounded-lg border border-gray-200"
                        >
                    @else
