                ...
                @section('breadcrumb')
                    <nav class="text-sm text-gray-600" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-2">
                            ...
                            <li class="text-gray-900 font-semibold">Edit Ingredient</li>
                        </ol>
                    </nav>
                <h1 class="text-4xl font-bold text-gray-900">Edit Ingredient</h1>
                @endsection
            </div>
            <p class="text-gray-600 mt-2">Update ingredient stock information</p>
        </div>
